...
import useClientGroupHook from '@/hooks/master/clientGroup/client-group-hook'
...
import AddClientGroupRecordForm from './AddClientGroupRecordForm'
...
const ClientGroupMaster = () => {
    ...
    const { clientGroupData,
        ...
        showModal,
        setShowModal,
        handleUpdateRecord } = useClientGroupHook();
    return (
        <div className="container-lg">
            <MasterListing value={key} />
            <div className="d-flex justify-content-center">
                <TabSection firstTabHeading={"Client Group List"} secondTabHeading={"Create New Client Group"} />
            </div>
            <div
            ...
            >
                ...
                >
                    <MasterTableListing tableData={clientGroupData} handleDeleteBtn={handleDeleteBtn} inputValue={inputValue} seInputValue={setInputValue} handleUpdateBtn={handleUpdateBtn} />
                </div>
                ...
                <div
                    ...
                    aria-labelledby="pills-home-tab"
                >
                    <AddClientGroupRecordForm handleInputChange={handleInputChange} inputValue={inputValue} seInputValue={setInputValue} handleSaveBtn={handleSaveBtn} />
                </div>
            </div>
